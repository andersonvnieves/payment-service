...
public class DeclinePaymentUseCaseTests
{
    private readonly Mock<IPaymentRepository> _paymentRepositoryMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly Mock<IPaymentProcessedEventPublisher> _eventPublisherMock;
    private readonly Mock<ICurrentUser> _currentUserMock;
    private readonly DeclinePaymentUseCase _sut;

    public DeclinePaymentUseCaseTests()
    {
        ...
        _sut = new DeclinePaymentUseCase(
    ...
    [Fact]
    public async Task ExecuteAsync_WhenPaymentExistsAndIsPending_ShouldDeclineUpdateCommitAndPublish()
    {
        // Arrange
        ...
        _eventPublisherMock.Setup(x => x.PublishAsync(It.Is<PaymentProcessedEvent>(e =>
            e.UserId == userId &&
            e.OrderId == orderId &&
            e.PaymentStatus == PaymentStatus.Rejected &&
            e.Name == userName &&
            e.Email == userEmail &&
