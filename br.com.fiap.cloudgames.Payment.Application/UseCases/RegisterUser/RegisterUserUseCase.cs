...
namespace br.com.fiap.cloudgames.Payment.Application.UseCases.User.RegisterUser;
...
public class RegisterUserUseCase
{
    ...
    public async Task<RegisterUserResponse> ExecuteAsync(RegisterUserRequest request)
    {
        try
        {
            ...
            var user = br.com.fiap.cloudgames.Payment.Domain.Aggregates.User.Create(name, email, identityUserId);
